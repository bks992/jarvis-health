...
export default function App() {
  ...
  if (!user) return (
    <div style={{minHeight:'100vh',background:'#F0F5F9',display:'flex',alignItems:'center',justifyContent:'center',padding:24}}>
      <style>{S}</style>
      {/* FIX #11: Clean welcome screen — just name + Google sign in */}
      <div style={{width:'100%',maxWidth:320,textAlign:'center'}}>
        <div style={{fontSize:28,fontWeight:800,color:'#0F172A',marginBottom:6,letterSpacing:'-0.5px'}}>
          Welcome to Badal Health Care
        </div>
        <div style={{marginTop:32}}>
          <button
            ...
            {loading
              ?<div style={{width:18,height:18,border:'2px solid #E2EBF0',borderTop:'2px solid #0EA5E9',borderRadius:'50%',animation:'spin 0.8s linear infinite'}}/>
